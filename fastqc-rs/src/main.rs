...
use fastqc_rs::runner;

/// FastQC - A high throughput sequence QC analysis tool
#[derive(Parser, Debug)]
#[command(name = "fastqc-rs", version = fastqc_rs::VERSION, about)]
struct Cli {
    ...
    // Allow both forms.
    #[arg(long = "min_length", alias = "min-length", value_name = "N", default_value = "0")]
    min_length: usize,
    ...
    #[arg(long = "dup_length", alias = "dup-length", value_name = "N", default_value = "0")]
    dup_length: usize,
