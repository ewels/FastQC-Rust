...
use crate::report::charts::{CHART_WIDTH, CHART_HEIGHT, svg_to_png, xml_escape};
...
pub fn create_zip_archive(
    ...
    for module in modules.iter() {
        ...
        if let (Some(image_name), Some(svg)) = (module.chart_image_name(), module.generate_chart_svg()) {
